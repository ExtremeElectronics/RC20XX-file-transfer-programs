...
# seperator
Frame(root, background="green", highlightcolor="green",
      highlightbackground="green").grid(sticky='NWSE', column=1, row=3, columnspan=5)
...
# selection lost on focus change bug fix -
